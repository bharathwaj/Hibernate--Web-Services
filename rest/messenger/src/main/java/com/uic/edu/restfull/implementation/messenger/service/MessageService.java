...
import com.uic.edu.restfull.implementation.messenger.exception.DataNotFoundException;
import com.uic.edu.restfull.implementation.messenger.model.Message;

public class MessageService {
	public MessageService() {
		messages.put(1L, new Message(1, "HelloWorld", "Bharathwaj"));
		messages.put(2L, new Message(2, "HelloJersey", "Bharathwaj"));
	}
